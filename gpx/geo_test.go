...
func TestElevationAngle(t *testing.T) {
	loc1 := Point{Latitude: 52.5113534275, Longitude: 13.4571944922, Elevation: NewNullableFloat(59.26)}
	loc2 := Point{Latitude: 52.5113568641, Longitude: 13.4571697656, Elevation: NewNullableFloat(65.51)}
